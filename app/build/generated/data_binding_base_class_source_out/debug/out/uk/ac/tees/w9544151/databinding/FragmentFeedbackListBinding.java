...
public final class FragmentFeedbackListBinding implements ViewBinding {
  ...
  private FragmentFeedbackListBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView rvFeedbacks, @NonNull TextView tvHead) {
  ...
  public static FragmentFeedbackListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFeedbackListBinding((ConstraintLayout) rootView, rvFeedbacks, tvHead);
    }
